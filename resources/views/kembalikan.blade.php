    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="kembalikan">Kembalikan <span class="sr-only">(current)</span></a>
                </li>
                </ul>
        ...
        <div class="content-header">
            <div class="container-fluid"> 
                <div class="col-sm-15">
                    <h4 class="m-0">Kembalikan Buku</h4>
                </div>
            </div>
            <!-- /.container-fluid -->
        </div>
                                                ...
                                                @if ($item->status === 'Dipinjam')
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form onsubmit="return confirm('Apakah Anda yakin ingin mengembalikan buku ini?');" action="{{ route('kembalikan.store', $item->id) }}" method="POST">
                                                                @csrf
